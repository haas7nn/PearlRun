...
public class Level5AmwajVictoryPanelAnimator : MonoBehaviour
{
    ...
    private void FillStatsFromGameManager()
    {
        ...
        Level5AmwajScoreManager sm = Level5AmwajScoreManager.Instance;
    ...
    public void OnReplayButton()
    {
        if (Level5AmwajRunnerGameManager.instance != null)
            Level5AmwajRunnerGameManager.instance.RestartLevel();
    }

    public void OnNextLevelButton()
    {
        if (Level5AmwajRunnerGameManager.instance != null)
            Level5AmwajRunnerGameManager.instance.LoadNextLevel();
    }

    public void OnMainMenuButton()
    {
        if (Level5AmwajRunnerGameManager.instance != null)
            Level5AmwajRunnerGameManager.instance.LoadMainMenu();
    }
