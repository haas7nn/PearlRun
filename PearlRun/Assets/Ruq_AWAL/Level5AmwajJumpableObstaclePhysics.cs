...
/// <summary>
/// Add this to any jumpable obstacle in Level 5 Amwaj.
...
public class Level5AmwajJumpableObstaclePhysics : MonoBehaviour
{
    [Header("Size")]
    ...
    void BuildColliders()
    {
        ...
        // Solid box body
        GameObject bodyGO = new GameObject("Level5AmwajPhysicsBody");
        ...
        GameObject capGO = new GameObject("Level5AmwajPhysicsTopCap");
