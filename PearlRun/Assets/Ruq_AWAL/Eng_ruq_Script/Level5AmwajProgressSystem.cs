...
public static class Level5AmwajProgressSystem
{
    private const string KEY_X = "Level5AmwajCheckpoint_X";
    private const string KEY_Y = "Level5AmwajCheckpoint_Y";
    private const string KEY_Z = "Level5AmwajCheckpoint_Z";
    private const string KEY_HAS = "Level5AmwajCheckpoint_HasSave";
    ...
    public static void SaveCheckpoint(Vector3 position)
    {
        ...
        Debug.Log("Level5AmwajProgressSystem: Saved checkpoint at " + position);
    }
    ...
    public static void ClearCheckpoint()
    {
        ...
        Debug.Log("Level5AmwajProgressSystem: Cleared checkpoint.");
    }
}