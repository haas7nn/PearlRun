...
public class Level5AmwajScoreManager : MonoBehaviour
{
    public static Level5AmwajScoreManager Instance;

    [Header("Level 5 Amwaj Data")]
    ...
    public void AddPearls(int amount)
    {
        ...
        Debug.Log("Level 5 Amwaj Pearls Collected: " + currentPearls);
    }
    ...
    public void CompleteLevel(int livesRemaining)
    {
        ...
        Debug.Log("LEVEL 5 AMWAJ COMPLETE");
